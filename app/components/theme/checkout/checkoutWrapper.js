...
// import { trackInitiateCheckout } from '@/lib/facebook-conversion-api';
            ...
            <div className='p-3 relative text-center flex flex-col items-center gap-3'>
                <div className='w-full relative rounded-xl pt-[100px] md:pt-[150px] overflow-hidden bg-black'>
                    <div className='relative z-10 px-[9.5vw]'>
                        <h1 className='text-2xl font-headingFontExtraBold uppercase mb-2 text-white'>Checkout</h1>
                        <div className='border-t-[1px] border-t-white/25 flex items-center justify-center pt-3'>
                            <Breadcrumb className="pb-10 text-white font-headingFontMedium">
                                <BreadcrumbList>
                                    ...
                                    <BreadcrumbItem>
                                        <Link href="/cart" className='text-white text-xs font-headingFontMedium uppercase'>Cart</Link>
                                    </BreadcrumbItem>
                                    <BreadcrumbSeparator>
                                        <ChevronRight className='text-white' />
                                    </BreadcrumbSeparator>
            ...
            <div className='xl:px-[9.5vw] mx-auto my-5 min-h-[40vh]'>
                ...
                <Form {...checkoutController}>
                    <div className='flex gap-5 flex-col xl:flex-row'>
                                ...
                                <div className='flex flex-col md:flex-row gap-5 w-[100%] flex-grow mb-5'>
                                    <div className='flex-1'>
                                        <div onClick={() => {
                                            ...
                                            setOpenShipAddressModal(false);
                                        }} className={`flex items-center px-5 py-4 gap-7 border-[1px] cursor-pointer rounded-full font-headingFontMedium uppercase text-sm ${!shipToDifferent ? 'text-white bg-black' : 'text-gray-500 hover:text-black hover:border-black transition ease-in-out'}`}>
                                    ...
                                    <div className='flex-1'>
                                        ...
                                        }} className={`flex items-center border-[1px] px-5 py-4 gap-3 cursor-pointer rounded-full font-headingFontMedium uppercase text-sm ${shipToDifferent ? 'text-white bg-black' : 'text-gray-500 hover:text-black hover:border-black transition ease-in-out'}`}>
                        ...
                        <div className='xl:w-5/12 bg-black rounded-3xl text-white'>
                            ...
                            <div className='mb-5 px-6 xl:px-10 xl:mb-10'>
                                <div className='text-xs text-white/75 mb-5 text-center'>Your personal data will be used to process your order, support your experience throughout this website, and for other purposes described in our <Link href="/help/privacy-policy" className='underline hover:text-white'>privacy policy</Link>.</div>
                                {/* <ReCAPTCHA
                                    sitekey={siteKey}
                                ...
                                <Button
                                    ...
                                    className="w-max mx-auto rounded-full bg-white font-headingFontMedium uppercase text-black flex gap-2 items-center justify-center border-[1px] border-transparent transition-all ease-in-out hover:bg-black hover:text-white hover:border-white"
