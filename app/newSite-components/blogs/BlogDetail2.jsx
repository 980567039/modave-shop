            ...
            <div className="blog-detail-wrap page-single-2">
              <div className="inner">
                ...
                <div className="image">
                  <Image
                    className="lazyload"
                    data-src="/newSite-images/blog/blog-details-2.jpg"
                    alt=""
                    src="/newSite-images/blog/blog-details-2.jpg"
                    width={1275}
                    height={717}
                  />
                </div>
                ...
                <div className="group-image d-flex gap-20">
                  <div>
                    <Image
                      alt=""
                      src="/newSite-images/blog/blog-details-3.jpg"
                      width={623}
                      height={468}
                    />
                  </div>
                  <div>
                    <Image
                      alt=""
                      src="/newSite-images/blog/blog-details-4.jpg"
                      width={623}
                      height={468}
                    />
                  </div>
